...
function viewModel() {
  ...
  self.students = new collection(backendAddress + "students", "ID");
  self.students.getGrades = function() {
    window.location = "#grades";
    self.grades.selectedStudent(this.ID());
    self.grades.url = backendAddress + "students/" + this.ID() + "/grades";
    self.grades.get();
  }
  ...
  self.courses = new collection(backendAddress + "subjects", "subject_id");
  ...
  self.grades = new collection(backendAddress + "grades", "grade_id");
  ...
  self.grades.add = function(form) {
    ...
    data.subject_id = self.grades.selectedCourse();
